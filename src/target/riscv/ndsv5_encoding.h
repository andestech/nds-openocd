...
DECLARE_CSR(mmsc_cfg4, CSR_MMSC_CFG4)
...
DECLARE_CSR(pmacfg8, CSR_PMACFG8)
DECLARE_CSR(pmacfg9, CSR_PMACFG9)
DECLARE_CSR(pmacfg10, CSR_PMACFG10)
DECLARE_CSR(pmacfg11, CSR_PMACFG11)
...
DECLARE_CSR(pmaaddr16, CSR_PMAADDR16)
DECLARE_CSR(pmaaddr17, CSR_PMAADDR17)
DECLARE_CSR(pmaaddr18, CSR_PMAADDR18)
DECLARE_CSR(pmaaddr19, CSR_PMAADDR19)
DECLARE_CSR(pmaaddr20, CSR_PMAADDR20)
DECLARE_CSR(pmaaddr21, CSR_PMAADDR21)
DECLARE_CSR(pmaaddr22, CSR_PMAADDR22)
DECLARE_CSR(pmaaddr23, CSR_PMAADDR23)
DECLARE_CSR(pmaaddr24, CSR_PMAADDR24)
DECLARE_CSR(pmaaddr25, CSR_PMAADDR25)
DECLARE_CSR(pmaaddr26, CSR_PMAADDR26)
DECLARE_CSR(pmaaddr27, CSR_PMAADDR27)
DECLARE_CSR(pmaaddr28, CSR_PMAADDR28)
DECLARE_CSR(pmaaddr29, CSR_PMAADDR29)
DECLARE_CSR(pmaaddr30, CSR_PMAADDR30)
DECLARE_CSR(pmaaddr31, CSR_PMAADDR31)
DECLARE_CSR(pmaaddr32, CSR_PMAADDR32)
DECLARE_CSR(pmaaddr33, CSR_PMAADDR33)
DECLARE_CSR(pmaaddr34, CSR_PMAADDR34)
DECLARE_CSR(pmaaddr35, CSR_PMAADDR35)
DECLARE_CSR(pmaaddr36, CSR_PMAADDR36)
DECLARE_CSR(pmaaddr37, CSR_PMAADDR37)
DECLARE_CSR(pmaaddr38, CSR_PMAADDR38)
DECLARE_CSR(pmaaddr39, CSR_PMAADDR39)
DECLARE_CSR(pmaaddr40, CSR_PMAADDR40)
DECLARE_CSR(pmaaddr41, CSR_PMAADDR41)
DECLARE_CSR(pmaaddr42, CSR_PMAADDR42)
DECLARE_CSR(pmaaddr43, CSR_PMAADDR43)
DECLARE_CSR(pmaaddr44, CSR_PMAADDR44)
DECLARE_CSR(pmaaddr45, CSR_PMAADDR45)
DECLARE_CSR(pmaaddr46, CSR_PMAADDR46)
DECLARE_CSR(pmaaddr47, CSR_PMAADDR47)
