...
static const struct service_driver burner_service_driver = {
	...
	.new_connection_handler = ndsv5_burner_new_connection,
	.input_handler = ndsv5_burner_input,
	.connection_closed_handler = ndsv5_burner_connection_closed,
...
int ndsv5_burner_server_init(struct target *target)
{
	...
	ret_value = add_service(&burner_service_driver, ndsv5_burner_port, 1, NULL);
