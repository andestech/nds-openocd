...
#define NDS_ETB_CAPTURE_CNT  (0x1C)  /* 0x1C	CAPTURE_CNT
				      * The number of words, which are captured after a trigger. (count[N:2])	RW */
...
#define NDS_ETM_CFG1         (0x04)	/* 0x4	CFG1  Revision,
					   multi-source support, number of range comparators, RAS depth	RO */
...
#define ETM_CFG1_MULTI_SOURCE     0x01  /* MULTI_SOURCE	0
					   1 = support multiple sources(frame, sync)	RO	IM */
...
/* ETM MODE */
#define ETM_MODE_CYCLE_ACCURATE    (0x01 << 0)  /* CYCLE_ACCURATE	0	*/
						/*                      1: generate cycle count packet	RW	0 */
#define ETM_MODE_DIRECT_TARGET     (0x01 << 1)  /* DIRECT_TARGET	1 */
						/*                      1: Generate target address of direct branches	RW	0 */
