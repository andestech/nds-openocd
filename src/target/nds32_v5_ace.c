...
static int32_t
get_ace_file_name (const char *aceconf, const char *marker, char **name)
{
...
static int32_t
loadSharedLib (const char *so_name)
{
	char *err_str = NULL;
...
int32_t
nds32_ace_init_v5(const char *aceconf)
{
...
int32_t 
get_ace_file_name_for_gdb_v5 (const char *aceconf, 
