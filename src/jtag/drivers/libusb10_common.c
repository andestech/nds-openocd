...
int use_libusb0 = 0;	/// Use libusb1 first
...
typedef int (*libusb0_control_msg_t)(libusb_device_handle *dev, int requesttype, int request, int value, int index, char *bytes, int size, int timeout);
...
typedef int (*libusb0_get_descriptor_t)(libusb_device_handle *dev, unsigned char type, unsigned char index, void *buf, int size);
